...
def main():
    ...
    #lists are like an array
    l = [ 1, 'two', 3, {'4': 'four' }, 5 ]

    # below is a tuple which is a sequence of values, each one accessible individually.
    # they can refer to data or they can be given names
    t = ( 'one', 'two', None, 'four', 'five' )


    s = set("It's a bird! It's a plane! It's Superman!")

    # dictionaries are key pair values
